...
<head>
    <title>Escollir Dossier</title>
    <link rel="shortcut icon" type="image/x-icon" href="./informatica/assets/images/logo.png" />
    ...
    <link rel="stylesheet" href="./informatica/assets/css/style.css ">
    <style>
        html,
        body {
            height: 100%;
